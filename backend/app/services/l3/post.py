...
# --------------------------------------------------------------------------
# Landmarks (brain_perception_upgrade.plan.md Change 1, Mechanism A): the
# four interior-structure channels (act/adx/sil/shot) now live in the shared
# pure module l3.landmarks so BOTH this pipeline and the vcut salience bridge
# (vcut.salience.build_landmarks) compute them from ONE source of truth
# (brain_cut_salience_parity.plan.md full-landmark-parity extension) -- no
# copy-paste drift. Re-exported here under the same private name so
# post._landmarks (and its callers/tests) keep resolving unchanged.
# --------------------------------------------------------------------------
from app.services.l3.landmarks import _landmarks  # noqa: E402
