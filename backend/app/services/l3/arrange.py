...
_ARRANGER_SYSTEM = (
    ...
    "and score. Avoid putting the same line on the main line twice unless that "
    "repeat is intended; you MAY place another member as a silent reaction/cutaway "
    "over that line's audio (e.g. the listener while the speaker talks). A "
    "SAME-BEAT GROUPS section lists each group's members.\n\n"
