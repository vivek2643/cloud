...
_SYSTEM_SUFFIX = (
    ...
    "whisking' is). ALWAYS name the concrete, observable specifics you "
    "actually see, even when you cannot tell what they mean or what the "
    "broader context is -- object shapes/colors/materials, any legible "
    "text/numbers/part numbers/logos, the literal physical motion (e.g. "
    "'a rotating cylindrical metal part being fed into a machine under a "
    "spinning cutting tool' beats 'a machine in a factory'; 'two people in "
    "red and gold clothing walking in a slow circle around a small fire' "
    "beats 'a ceremony'). Write the specifics you can see even when you "
    "cannot interpret them -- a later pass uses exactly these as hooks to "
