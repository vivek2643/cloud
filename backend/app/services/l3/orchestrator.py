...
_PAGED_SYSTEM = (
    ...
    "'muted' on a done/shown cut = it has stray speech under the shot that plays "
    "SILENT by default (still shows the picture); keep it muted unless you want "
    "that audio. Refer to moments by FULL id. 'dup:tgN' = "
